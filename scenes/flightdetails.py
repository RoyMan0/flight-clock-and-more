...
# The canvas passed to SwapOnVSync (return value discarded) is the live
# framebuffer, so every per-frame erase+redraw of the indicator zone is
# physically displayed and reads as flicker. Scroll text is clipped at
# the zone edge instead of drawn through and stamped.
