...
#    try:
#        subprocess.Popen(
#            ["mpg123","/home/royman/its-a-plane-python/airbus.mp3"],
...
class Overhead:
    def __init__(self):
        ...
        #new lines for aibus sound below
        self._alerted_callsigns = set()

        #end new lines for airbus sound
            ...
            for f in flights:
                ...
                while retries:
                    ...
                    try:
                        ...
                        #sound code testing
                        print("Detected flight:", callsign)
                        #play sound
                        if callsign and callsign not in self._alerted_callsigns:
                            print("Playing sound for:", callsign)
                            play_plane_sound()
